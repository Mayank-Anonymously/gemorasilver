...
const CheckoutPage = () => {
	...
	/* ==========================
		FREE GIFT ELIGIBILITY (ONLY LOGIC)
	========================== */
	const isEligibleForFreeGift = cartItems.length === 1;
	...
	return (
		<Screen>
			<div
				...
				{/* FREE GIFT MESSAGE (TOP) */}
				{isEligibleForFreeGift && (
					<div
						className='mb-3 text-center p-2'
						style={{
							background: '#fff0f3',
							border: '1px dashed #c9184a',
							borderRadius: '8px',
							color: '#7b001c',
							fontSize: '14px',
							fontWeight: '500',
						}}>
						💖 Valentine’s Special — Buy 1 item & get a
							...
							<Card.Body>
								...
								{isEligibleForFreeGift && (
									<div
										...
										🎁 You are eligible for a<strong> FREE Gift</strong>
									</div>
								)}
